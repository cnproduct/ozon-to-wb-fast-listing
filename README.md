...
### 4. 💰 5倍定价与官方 50% 促销大促策略
- 自动根据 Ozon 原价换算目标到手价：`实售到手价 = Ozon原价 × 5.0`。
- 上架划线原价：`划线价 = 实售到手价 ÷ (1 - 0.5) = Ozon原价 × 10.0`。
- 自动下发 50% 官方大促折扣任务（`discounts-prices-api`），前台展示高吸引力 5 折大促标签。
- 现货库存秒级注入（如莫斯科1仓 ID `2156484` 设置 10 件现货）。
