...
### 4. 💰 纯卢布绿标价 6 倍实售与 2 倍划线标价法则 (50% 官方大促)
- **纯卢布无汇率折算**：直接以 Ozon 页面真实的绿标卡价（Green Badge Price）为基准，不涉及任何人民币或汇率换算，直接下发卢布数值，彻底杜绝币种混淆。
- **锚定效应促销模型**：买家端目标到手价精准等于 Ozon 绿标价的 6 倍（$P_{\text{sell}} = P_{\text{ozon\_green}} \times 6$），自动反推 2 倍划线标价（$P_{\text{strike}} = P_{\text{sell}} \times 2 = P_{\text{ozon\_green}} \times 12$），并下发 50% 官方大促折扣。
